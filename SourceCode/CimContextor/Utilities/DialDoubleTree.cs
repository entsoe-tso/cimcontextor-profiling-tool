...
{
    public partial class DialDoubleTree : Form
    {
        ...
        public bool domaininputvisible
        {
            get { return this.textBox2.Visible; }
            set { this.textBox2.Visible = value; }
        }
        public string domaintreeLabel
        {
            get { return this.label4.Text; }
            set { this.label4.Text = value; }
        }
        public string domaininputLabel
        {
            get { return this.label3.Text; }
            set { this.label3.Text = value; }
        }
        public bool domaininputlabelvisible
        {
            get { return this.label3.Visible; }
            set { this.label3.Visible = value; }
        }
        public bool cball
        {
        ...
        public DialDoubleTree(EA.Repository repo, EA.Package racinepack,bool multiselect)
        {
            try
            {
                this.repo = repo;
                ...
                if (racinepack == null) { Main.ongoing = false; this.Close(); }
                this.util = new Utilitaires(repo);
                this.dicCimPackagesByName = new Dictionary<string, Package>();
                if (!this.dicCimPackagesByName.ContainsKey(this.toppack.Name)) this.dicCimPackagesByName[this.toppack.Name] = toppack;
                util.getAllPackagesInAPackage(repo, toppack, dicCimPackagesByName);
                InitializeComponent();
                this.textBox1.Text = "";
                this.domaininputlabelvisible = false;
            ...
            System.Windows.Forms.TreeViewEventArgs e)
        {
            ...
            switch ((e.Action))
            {
                ...
                case TreeViewAction.ByMouse:
                    ...
                    string packname = treeView1.SelectedNode.Text;
                    if (this.dicCimPackagesByName.ContainsKey(packname)) profilespack = this.dicCimPackagesByName[packname];
                         
                if(profilespack !=null)
                    {
                        TreeNode allnodes = getNodeFrom(profilespack);
                        treeView2.Nodes.Add(allnodes);
                        this.domaininputlabelvisible = true;
        ...
        private void Bok_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (treeView1.SelectedNode.Text != treeView1.Nodes[0].Text) // we have selected somthig different than the top
                    {
                        Utilitaires.dicSelectedPackage["v1_" + selectednode1.Text] = dicCimPackagesByName[selectednode1.Text];
                        if (selectednode2 != null)
                        {
                            Utilitaires.dicSelectedPackage["v2_" + selectednode2.Text] = dicCimPackagesByName[selectednode2.Text];
                        }
                    }
                }
