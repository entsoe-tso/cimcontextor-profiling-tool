...
{
    partial class EditDuplicateForRdfsConnectorsForm
    {
        /// <summary>
        ...
        protected override void Dispose(bool disposing)
        {
             util = new utilitaires.Utilitaires();// pour test am aug 2016
                ...
                if (Main.valtest1 != null) // am aug 2016
                {
                    ...
                    util.testConnectorState(Repo.GetConnectorByGuid(Main.valtest1), "Eduplicate ligne 22");
                }
            ...
            if (Main.valtest1 != null) // am aug 2016
            {
                ...
                util.testConnectorState(Repo.GetConnectorByGuid(Main.valtest1), "Eduplicate ligne 31");
            }
            base.Dispose(disposing);
            if (Main.valtest1 != null) // am aug 2016
            {

                util.testConnectorState(Repo.GetConnectorByGuid(Main.valtest1), "Eduplicate ligne 37");
            }
        }
        ...
        private void InitializeComponent()
        {
           ...
           // this.ColSubClientEndRole.Text = "Selected class role";
            this.ColSubClientEndRole.Text = "Class role";
            ...
            this.Load += new System.EventHandler(this.EditDuplicateForRdfsConnectorsForm_Load);
